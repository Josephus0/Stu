...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" >
    <div class="modal-dialog" role="document" >
        <div class="modal-content" style="height:180px;width: 300px">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">确定设置为首页推荐文章？</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                <button type="button" class="btn btn-primary" onclick="torecommend()">确定</button>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="panel panel-default">
            <div class="panel-heading">
                <div class="panel-title">
                    ...
                    <button class="torecommend" onclick="torecommend()">设为首页推荐</button>
...
<script type="text/javascript">
    ...
    function torecommend() {
        if(confirm('确定设置为首页推荐文章？')){
            var articleflag = ${param.articleid};
            var xmlhttp = ajaxFunction();
            xmlhttp.open("Post", "torecommdsev?articleid=" + articleflag, true);
            xmlhttp.send();
        }
    }
    function ajaxFunction() {
