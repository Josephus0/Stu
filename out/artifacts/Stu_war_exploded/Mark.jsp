    ...
    <div class="modal-dialog" role="document" >
        <div class="modal-content" style="height:580px;width: 500px">
            ...
            <div class="modal-body">
                <form id="articleform"  action="releaseartic" method="post">
                    <div class="form-group">
                        <p style="background-color: #ffe2d4">请勿发布涉及政治、广告、营销、翻墙、违反国家法律法规等内容</p>
                        <label>文章标签:</label><input type="text" class="form-control" style="width: 130px; position: relative;top: 2px;" id="atags1" name="atags1">
                        <input type="text" style="width: 130px;position: absolute;top: 90px;left: 190px;" class="form-control" id="atags2" name="atags2">
                        <input type="text" style="width: 130px;position: absolute;top: 90px;left: 355px;" class="form-control" id="atags3" name="atags3">
                        <label>分类专栏:</label>
                        <select  class="form-control" id="aclass" name="aclass">
                            <option value="程序人生">程序人生</option>
                            <option value="算法">算法</option>
                            <option value="学习笔记">学习笔记</option>
                            <option value="Java">Java</option>
                            <option value="Python">前端</option>
                        </select>
                        <label>文章类型:</label>
...
<div class="MarkTop" style="position: absolute; z-index: 10">
    <ul>
        ...
        <li><input class="Blogtitle" id="Blogtitle" placeholder="Title" name="title" form="articleform"></li>
        <li><button type="button" id="MarkBtn1" class="MarkBtn1">保存草稿</button></li>
...
<div id="deditor" class="Markdown">
    <textarea style="display:none;" form="articleform" id="txttextarea" name="txttextarea"></textarea>
...
<script type="text/javascript">
    ...
    function Release() {txttextarea
        var Blogtitle = $("#Blogtitle").val();
        var txttextarea = $("#txttextarea").val();
        var atags1 = $("#atags1").val();
        var brief = $("#brief").val();
        if(Blogtitle==""){
            alert("标题不能为空");return;
        }
